...
defineModuleConfig('indexer', {
  ...
  'provider.apiKey': {
    ...
    default: '',
    env: ['SISO_NOTES_INDEXER_SEARCH_API_KEY', 'string'],
  },
  'provider.username': {
