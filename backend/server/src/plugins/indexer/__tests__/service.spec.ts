  ...
  await indexerService.write(
    ...
    [
      ...
      },
      {
        ...
        flavour: 'sisonotes:page',
        refDocId: [docId1],
        ref: ['{"type": "sisonotes:page", "id": "docId1"}'],
      },
      {
        workspaceId: workspace.id,
        docId: docId3,
        ...
        ref: [
          '{"type": "sisonotes:page", "id": "docId2"}',
          '{"type": "sisonotes:page", "id": "docId1"}',
        ],
      },
    ],
    {
  ...
  await indexerService.write(
    ...
    [
      ...
      // matched
      {
        ...
        parentFlavour: 'sisonotes:database',
        additional: '{"foo": "bar3"}',
