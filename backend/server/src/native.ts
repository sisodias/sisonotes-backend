...
export const SISO_NOTES_PRO_PUBLIC_KEY = serverNativeModule.SISO_NOTES_PRO_PUBLIC_KEY;
export const SISO_NOTES_PRO_LICENSE_AES_KEY =
  serverNativeModule.SISO_NOTES_PRO_LICENSE_AES_KEY;
...
const LLM_STREAM_END_MARKER = '__SISO_NOTES_LLM_STREAM_END__';
