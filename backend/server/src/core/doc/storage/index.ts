// This is a totally copy of definitions in [@siso/space-store]
// because currently importing cross workspace package from [@siso/server] is not yet supported
// should be kept updated with the original definitions in [@siso/space-store]
