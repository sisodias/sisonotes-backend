...
const ALLOW_RUN = process.env.SISO_NOTES_DOCKER_CLEAN === '1';
const VERBOSE = process.env.SISO_NOTES_DOCKER_CLEAN_VERBOSE === '1';
...
if (!ALLOW_RUN) {
  log('skip (set SISO_NOTES_DOCKER_CLEAN=1 to enable)');
  process.exit(0);
}
