...
mod tests {
  ...
  fn magic_link_otp_uses_scoped_purpose_and_email_hash() {
    ...
    assert_ne!(token_hash("user@sisonotes.test"), "user@sisonotes.test");
    assert_eq!(token_hash("user@sisonotes.test"), token_hash("user@sisonotes.test"));
    assert_ne!(token_hash("user@sisonotes.test"), token_hash("other@sisonotes.test"));
  }
