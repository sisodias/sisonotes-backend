...
use sisonotes_common::napi_utils::map_napi_err;
...
#[napi]
pub const SISO_NOTES_PRO_PUBLIC_KEY: Option<&'static str> = std::option_env!("SISO_NOTES_PRO_PUBLIC_KEY");

#[napi]
pub const SISO_NOTES_PRO_LICENSE_AES_KEY: Option<&'static str> = std::option_env!("SISO_NOTES_PRO_LICENSE_AES_KEY");
