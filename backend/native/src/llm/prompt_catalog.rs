...
fn builtin_from_token(name: &str) -> Option<PromptBuiltin> {
  match name {
    "sisonotes::date" => Some(PromptBuiltin::Date),
    "sisonotes::language" => Some(PromptBuiltin::Language),
    "sisonotes::timezone" => Some(PromptBuiltin::Timezone),
    "sisonotes::hasDocsRef" => Some(PromptBuiltin::HasDocs),
    "sisonotes::hasFilesRef" => Some(PromptBuiltin::HasFiles),
    "sisonotes::hasSelected" => Some(PromptBuiltin::HasSelected),
    "sisonotes::hasCurrentDoc" => Some(PromptBuiltin::HasCurrentDoc),
    _ => None,
  }
}
...
mod tests {
  ...
  fn should_load_prompt_catalog() {
    ...
    let chat = built_in_prompt("Chat With SISO Notes AI").expect("chat prompt");
