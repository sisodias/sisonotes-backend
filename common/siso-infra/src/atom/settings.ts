import { DebugLogger } from '@siso/debug';
import { setupGlobal } from '@siso/env/global';
...
const logger = new DebugLogger('sisonotes:settings');
...
export const APP_SETTINGS_STORAGE_KEY = 'sisonotes-settings';
...
const appSettingEffect = atomEffect(get => {
  ...
  if (BUILD_CONFIG.isElectron) {
    ...
    // this api type in @siso/electron-api, but it is circular dependency this package, use any here
