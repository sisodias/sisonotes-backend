...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('sisonotes');
    ...
    expect(workspaceService.system.appName).toEqual('sisonotes');
    ...
    expect(pageService.system.appName).toEqual('sisonotes');
